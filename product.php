...
<style>
    ...
    @media(max-width: 768px) { 
        ...
        .tryon-content { grid-template-columns: 1fr; overflow-y: scroll; }
    }
</style>
</head>
<body>
...
<div id="tryon-modal">
    <div class="tryon-content">
        ...
        <div style="border-right: 1px solid #333; padding: 2rem;">
            ...
            <div style="margin-top: 2rem; border: 1px solid #333; padding: 10px;">
                <p>> MESH_QUALITY: HIGH</p>
                <p>> TEXTURE: 4K</p>
            </div>
        </div>
        ...
        <div style="position: relative; background: #050505; display: flex; align-items: center; justify-content: center;">
            ...
            <div style="text-align: center;">
                <h1 style="font-size: 8rem; opacity: 0.1; color: #fff;">AU</h1>
                <p>[CAMERA_FEED_SIMULATION]</p>
        ...
        <div style="border-left: 1px solid #333; padding: 2rem;">
            ...
            <div style="width: 100%; height: 5px; background: #333; margin-top: 5px;"><div style="width: 75%; height: 100%; background: #00f3ff;"></div></div>
            <p style="margin-top: 20px;">CONFIDENCE: 98%</p>
            <div style="width: 100%; height: 5px; background: #333; margin-top: 5px;"><div style="width: 98%; height: 100%; background: #00f3ff;"></div></div>
        </div>
    </div>
</div>
